    ...
    >
      ...
      <CardContent className="grid gap-8 md:grid-cols-2">
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              max={80}
              step={0.5}
              onValueChange={([v]) => setEbitdaMargin(v)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={type}
              onValueChange={(v: "term" | "rcf") => setType(v)}
            >
              <SelectTrigger>
            ...
            {type === "term" ? (
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  max={10}
                  step={1}
                  onValueChange={([v]) => setTenorYears(v)}
                />
              </div>
            ) : (
              <div className="space-y-2">
        ...
        <div className="space-y-6">
          <Tabs
            defaultValue={type}
            onValueChange={(v) => setType(v as "term" | "rcf")}
          >
            ...
            <TabsContent value="rcf" className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">
                  Monthly interest at {utilization}% utilization
                </span>
