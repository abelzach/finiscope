...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent dark:bg-black dark:border-white/[0.2] shadow-input flex flex-wrap sm:flex-nowrap justify-center sm:space-x-4 px-3 py-2 sm:px-6 sm:py-3 gap-2"
    >
      {children}
    </nav>
  );
